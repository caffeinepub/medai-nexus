...
function AboutSection() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "about-section", id: "about", "data-ocid": "about.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-inner", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "about-tag", children: "MISSION" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "about-title", children: "ABOUT MEDAI NEXUS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-divider" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "about-desc", children: [
        "MedAI Nexus was built to give everyone access to intelligent, data-driven health insights. By combining",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "270+ symptoms" }),
        " and ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "122 diseases" }),
        " in a powerful matching engine, it helps you understand potential health conditions quickly — from the comfort of your home."
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-steps-label", children: "HOW TO USE" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-steps", children: steps.map((step) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "about-step-card glass-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "about-step-num", children: step.num }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "about-step-title", children: step.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-step-desc", children: step.desc })
    ] }, step.num)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "about-disclaimer", children: "⚕️ MedAI Nexus provides informational insights only. Always consult a qualified medical professional for diagnosis and treatment." })
  ] }) });
}
...
function ActivationScreen({ onActivate }) {
  ...
  const [hexStream, setHexStream] = reactExports.useState(
    []
  );
  const [bioDots, setBioDots] = reactExports.useState(0);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "activation-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activation-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: hexStream.map((line) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: line.text }, line.id))
      }
    ),
    [
    ...
    ].map((c, _i2) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "svg",
      {
        "aria-hidden": "true",
        style: {
        ...
        viewBox: "0 0 22 22",
        fill: "none",
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: c.d, stroke: accentColor, strokeWidth: "1.5", fill: "none" })
      },
      c.d
    )),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activation-logo", style: { position: "relative" }, children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "24", r: "4", fill: "#A78BFA" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: "24",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "activation-title", children: "MEDAI NEXUS" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "activation-subtitle", children: "SYSTEM INITIALIZATION REQUIRED" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
        ...
        children: `BIOMETRIC SCAN INITIATED${".".repeat(bioDots)}`
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "activation-divider" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "activation-label", htmlFor: "api-key-input", children: "ENTER API KEY" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        id: "api-key-input",
    ...
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "activation-error", children: "⚠ API Key Required to Initialize System" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "activation-footer-note", children: "Enter your OpenAI API key to enable AI analysis, or any key to use local detection." })
  ] }) });
}
function HUDOverlay() {
  const [time, setTime] = reactExports.useState("");
  const [bars, setBars] = reactExports.useState([1, 1, 1, 1, 1]);
  reactExports.useEffect(() => {
    const tick = () => {
      const now2 = /* @__PURE__ */ new Date();
      setTime(`${now2.toISOString().replace("T", " ").slice(0, 19)} UTC`);
    };
    tick();
  ...
  reactExports.useEffect(() => {
    const id = setInterval(() => {
      setBars(
        (prev) => prev.map(
          (_, i) => Math.random() > 0.3 ? i + 1 : Math.ceil(Math.random() * (i + 1))
        )
      );
    }, 800);
    return () => clearInterval(id);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", top: 16, left: 16 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              "aria-hidden": "true",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 4 }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: "LAT: 40.7128 | LON: -74.0060" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginTop: 2, color: hudDim }, children: "GRID REF: NY-SEC-7714" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { marginTop: 4 }, children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 4 }, children: "SIGNAL STRENGTH" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    style: {
                    ...
                    children: [1, 2, 3, 4, 5].map((level) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
                        style: {
                          width: 4,
                          height: `${level * 3}px`,
                          background: bars[level - 1] >= level ? "rgba(139, 92, 246, 0.9)" : "rgba(139, 92, 246, 0.15)",
                          borderRadius: 1,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { position: "absolute", bottom: 16, left: 16 }, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { marginBottom: 4 }, children: "MedAI NEXUS v3.0 | BUILD 2026.03.21" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: hudDim }, children: "NEURAL ENGINE: ACTIVE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "svg",
            {
              "aria-hidden": "true",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { color: hudDim }, children: "SESSION: ENCRYPTED" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
...
function Hero() {
  ...
  const dataLabels = [
    ...
    { text: "SYNAPTIC LINK", top: "25%", right: "2%", left: void 0 },
    {
      text: "BIOMARKER",
      bottom: "18%",
      right: "5%",
    ...
    { text: "DNA SEQUENCE", bottom: "5%", left: "60%", top: void 0 },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-content", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-accent-bar" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-text", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "hero-title", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "NEURAL" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hero-title-highlight", children: "DISEASE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "DETECTION" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "hero-subtitle", children: "Advanced AI-powered diagnostic analysis using pattern recognition and machine learning to identify potential health conditions." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "hero-stats", children: [
          { value: "270+", label: "Symptoms" },
          { value: "122", label: "Diseases" },
          { value: "AI", label: "Powered" },
          { value: "Live", label: "Analysis" }
        ].map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-stat", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hero-stat-value", children: s.value }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "hero-stat-label", children: s.label })
        ] }, s.label)) })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-visual hero-visual-enhanced", children: [
      rings.map((ring) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            ...
            boxShadow: ring.size < 150 ? `0 0 12px ${ring.color}` : void 0
          }
        },
        ring.cls
      )),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "holo-core", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          width: "60",
          height: "60",
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "30", cy: "30", r: "5", fill: "#A78BFA" }),
            ringAngles.map((deg) => {
              const rad = deg * Math.PI / 180;
              return /* @__PURE__ */ jsxRuntimeExports.jsx(
                "line",
      ...
      dataLabels.map((label) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "holo-dots", children: dotKeys.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          className: "holo-dot",
...
function Navbar({ theme, onToggleTheme, isActivated }) {
  const [scanPos, setScanPos] = reactExports.useState(-100);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar", style: { overflow: "hidden" }, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "navbar-logo", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "14", cy: "14", r: "5", fill: "#A78BFA", opacity: "0.8" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: "14",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "navbar-brand", children: "MEDAI NEXUS" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "navbar-links", children: ["scan", "results", "about"].map((id, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "button",
      {
        type: "button",
        className: "nav-link",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "span",
        {
          style: {
            ...
            fontSize: "0.65rem",
            color: "#A78BFA",
            textShadow: "0 0 10px rgba(167,139,250,0.7), 0 0 20px rgba(167,139,250,0.3)",
            letterSpacing: "0.08em"
          },
          children: "SYS://ONLINE"
        }
      ),
      isActivated && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "status-pill active", children: "● SYSTEM ACTIVE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
...
function getDoctorVisitAdvice(severity) {
  switch (severity) {
    case "low":
...
function ResultDashboard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "result-section", id: "results", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "AI DIAGNOSTIC RESULTS" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-line" })
    ] }),
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loading-panel", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-scan-bars", children: barKeys.map((k, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "loading-text", children: "INITIALIZING AI ANALYSIS..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "loading-sub", children: "Processing neural pattern recognition" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "results-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card card-cyan result-top", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "result-badge", children: "PRIMARY DIAGNOSIS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "result-disease-name", children: results[0].disease.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-confidence-big", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#A78BFA" }, children: [
            results[0].confidence,
            "%"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "result-confidence-label", children: "MATCH" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            ...
            children: results[0].disease.severity.toUpperCase()
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "result-desc", children: results[0].disease.description }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "matched-symptoms", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "matched-label", children: "MATCHED SYMPTOMS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "matched-tags", children: results[0].matchedSymptoms.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "matched-tag", children: s }, s)) })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panels-grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panel care-panel--diet", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panel-header", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "care-panel-icon", children: "🥗" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "care-panel-title", children: "RECOMMENDED DIET" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "care-panel-content", children: results[0].disease.diet })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panel care-panel--doctor", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panel-header", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "care-panel-icon", children: "🏥" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "care-panel-title", children: "WHEN TO SEE A DOCTOR" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "care-panel-content", children: getDoctorVisitAdvice(results[0].disease.severity) })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panel care-panel--medicine", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "care-panel-header", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "care-panel-icon", children: "💊" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "care-panel-title", children: "COMMON MEDICINES" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "care-panel-content", children: results[0].disease.medicines })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "care-disclaimer", children: "⚠️ This is for informational purposes only. Always consult a licensed medical professional before taking any medication." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "results-list-col", children: [
        results.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card result-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "result-rank", children: `#${i + 1}` }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-info", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "result-name", children: r.disease.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "confidence-bar-container", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
        ...
        aiResponse && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card ai-response-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ai-badge", children: "🤖 AI ANALYSIS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ai-response-text", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypingText, { text: aiResponse }) })
        ] }),
        !aiResponse && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card ai-response-card", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ai-badge", children: "🤖 LOCAL ANALYSIS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "ai-response-text", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            TypingText,
            {
...
function SymptomPanel({
  ...
  const filtered = reactExports.useMemo(() => {
    return symptoms2.filter((s) => {
      const matchCat = category === "all" || s.category === category;
      const matchSearch = s.name.toLowerCase().includes(search.toLowerCase());
      return matchCat && matchSearch && !selectedSymptoms.includes(s.name);
    });
  }, [symptoms2, category, search, selectedSymptoms]);
  const autocomplete = reactExports.useMemo(() => {
    if (!search.trim()) return [];
    return symptoms2.filter(
      (s) => s.name.toLowerCase().includes(search.toLowerCase()) && !selectedSymptoms.includes(s.name)
    ).slice(0, 8);
  }, [symptoms2, search, selectedSymptoms]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "symptom-section", id: "scan", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "DIAGNOSTIC CONSOLE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-line" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "symptom-grid", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card card-cyan", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-number", children: "01" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "card-title", children: "API STATUS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "api-status-display", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: apiKeyActive ? "text-green" : "text-muted", children: apiKeyActive ? "KEY ACTIVE — READY" : "NO KEY" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "api-status-desc", children: apiKeyActive ? "AI analysis enabled via OpenAI API. Local pattern matching also active." : "Local pattern matching active. Add API key for AI-enhanced analysis." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "button", className: "btn-secondary", onClick: onChangeKey, children: apiKeyActive ? "CHANGE API KEY" : "ACTIVATE API KEY" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "api-scan-visual", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scan-bar" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scan-bar", style: { animationDelay: "0.4s" } }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "scan-bar", style: { animationDelay: "0.8s" } })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card card-purple", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "card-number", children: "02" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "card-title", children: "SYMPTOM ANALYSIS" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "search-container", children: [
          ...
          showDropdown && autocomplete.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "autocomplete-dropdown", children: autocomplete.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `cat-badge cat-${s.category}`, children: s.category }),
                s.name
              ]
            },
            s.id
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "category-pills", children: ["all", "general", "critical", "rare"].map(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "symptom-chips-container", children: [
          filtered.slice(0, 24).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
          ...
          filtered.length > 24 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "chips-more", children: `+${filtered.length - 24} more — use search` })
        ] }),
        selectedSymptoms.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "selected-symptoms", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "selected-label", children: `SELECTED SYMPTOMS (${selectedSymptoms.length})` }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "selected-tags", children: selectedSymptoms.map((s) => /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "selected-tag", children: [
            s,
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
...
const diseases = [
  {
    ...
    description: "A viral infection of the upper respiratory tract caused by rhinoviruses.",
  ...
  },
  {
    ...
    precautions: "Annual flu vaccine, rest, antiviral medications if prescribed, isolation",
  ...
  },
  {
    ...
    precautions: "Vaccination, masking, social distancing, hand hygiene, isolation if positive",
    description: "A respiratory illness caused by the SARS-CoV-2 coronavirus with wide-ranging symptoms.",
    medicines: "Paracetamol, Ibuprofen, Nirmatrelvir/Ritonavir (Paxlovid), Vitamin C & D supplements"
  },
  {
    id: "d4",
    name: "Pneumonia",
    ...
    precautions: "Vaccination, antibiotics as prescribed, rest, breathing exercises",
    description: "Infection causing inflammation in air sacs of one or both lungs, which may fill with fluid.",
  ...
  },
  {
    ...
    precautions: "Avoid smoking and irritants, use humidifier, rest, stay hydrated",
    description: "Inflammation of the bronchial tubes that carry air to and from lungs.",
  ...
  },
  {
    ...
    precautions: "Use inhalers, avoid triggers, monitor peak flow, keep rescue inhaler handy",
    description: "A condition where airways narrow and swell, producing extra mucus and causing breathing difficulty.",
    medicines: "Salbutamol (rescue inhaler), Budesonide (inhaled steroid), Montelukast, Ipratropium"
  },
  {
    id: "d7",
    name: "COPD",
    ...
    precautions: "Quit smoking, pulmonary rehabilitation, oxygen therapy, avoid air pollutants",
    description: "Chronic obstructive pulmonary disease - a chronic inflammatory lung disease causing obstructed airflow.",
  ...
  },
  {
    ...
    precautions: "Complete antibiotic course (6-9 months), isolation, BCG vaccination, regular check-ups",
  ...
  },
  {
    ...
    precautions: "Antimalarial medications, mosquito nets, repellents, eliminate standing water",
    description: "A life-threatening disease caused by Plasmodium parasites transmitted through mosquito bites.",
  ...
  },
  {
    ...
    precautions: "Mosquito prevention, bed rest, monitor platelet count, avoid aspirin",
    description: "A mosquito-borne viral infection causing severe flu-like illness and sometimes deadly complications.",
    medicines: "Paracetamol, IV fluids (hospital), Platelet transfusion if needed"
  },
  {
    id: "d11",
    name: "Typhoid Fever",
    ...
    precautions: "Typhoid vaccine, clean water, food hygiene, antibiotics as prescribed",
  ...
  },
  {
    ...
    precautions: "Safe water, proper sanitation, oral cholera vaccine, immediate rehydration",
    description: "A bacterial infection causing profuse watery diarrhea that can lead to severe dehydration.",
    medicines: "ORS (Oral Rehydration Salts), Doxycycline, Azithromycin, IV fluids"
  },
  {
    id: "d13",
    name: "Hepatitis A",
    ...
    description: "A highly contagious liver infection caused by Hepatitis A virus, usually spread through contaminated food.",
  ...
  },
  {
    ...
    precautions: "Hepatitis B vaccine, safe sex, avoid sharing needles, regular monitoring",
  ...
  },
  {
    ...
    precautions: "Avoid sharing needles, safe sex, antiviral treatment, regular liver monitoring",
  ...
  },
  {
    ...
    precautions: "Avoid alcohol and hepatotoxic drugs, treat underlying cause, regular monitoring",
    description: "Late-stage scarring of the liver caused by liver diseases and conditions like hepatitis and chronic alcoholism.",
    medicines: "Spironolactone, Furosemide, Lactulose, Propranolol (for varices)"
  },
  {
    id: "d17",
    name: "Gastritis",
    ...
    precautions: "Avoid NSAIDs, limit alcohol, manage stress, H. pylori treatment if needed",
    description: "Inflammation of the stomach lining, causing stomach pain, nausea, and vomiting.",
    medicines: "Omeprazole, Antacids (Aluminium hydroxide), Domperidone, Amoxicillin (if H. pylori)"
  },
  {
    id: "d18",
    name: "Peptic Ulcer",
    ...
    precautions: "H. pylori eradication, avoid NSAIDs and alcohol, stress management",
    description: "Open sores that develop on the inner lining of the stomach and upper small intestine.",
    medicines: "Omeprazole, Pantoprazole, Sucralfate, Amoxicillin + Clarithromycin (H. pylori)"
  },
  {
    id: "d19",
    name: "GERD",
    ...
    precautions: "Elevate head while sleeping, maintain healthy weight, avoid tight clothing",
    description: "Gastroesophageal reflux disease - chronic acid reflux causing esophageal irritation.",
  ...
  },
  {
    ...
    precautions: "Stress management, regular exercise, identify and avoid triggers",
    description: "A common disorder affecting the large intestine causing cramping, abdominal pain, and altered bowel habits.",
    medicines: "Mebeverine, Loperamide (for diarrhea), Lactulose (for constipation), Peppermint oil capsules"
  },
  {
    id: "d21",
    ...
    precautions: "Medication adherence, avoid NSAIDs, quit smoking, regular colonoscopy",
  ...
  },
  {
    ...
    precautions: "Seek immediate medical attention, surgical removal (appendectomy)",
    description: "Inflammation of the appendix requiring emergency surgical removal.",
    medicines: "IV Antibiotics (Cefazolin + Metronidazole), Paracetamol, Morphine (hospital)"
  },
  {
    id: "d23",
    name: "Pancreatitis",
    ...
    precautions: "Avoid alcohol, gallstone treatment, enzyme replacement therapy if needed",
    description: "Inflammation of the pancreas, which can be acute or chronic.",
    medicines: "IV fluids, Morphine, Pancreatic enzyme supplements, Proton pump inhibitors"
  },
  {
    id: "d24",
    name: "Kidney Stones",
    ...
    precautions: "Stay hydrated, dietary modifications, medications to prevent recurrence",
    description: "Hard deposits made of minerals and salts that form inside the kidneys.",
    medicines: "Ibuprofen, Tamsulosin (alpha blocker), Potassium citrate, Allopurinol"
  },
  {
    id: "d25",
    ...
    precautions: "Stay hydrated, proper hygiene, complete antibiotic course, urinate after intercourse",
  ...
  },
  {
    ...
    precautions: "Control blood pressure and diabetes, avoid nephrotoxic drugs, dialysis if needed",
    description: "Gradual loss of kidney function over time affecting fluid balance and waste removal.",
  ...
  },
  {
    ...
    precautions: "Regular monitoring, medication adherence, reduce salt, exercise regularly",
    description: "High blood pressure putting extra strain on blood vessels and heart.",
  ...
  },
  {
    ...
    precautions: "Immediate medical care, medications, cardiac rehabilitation, lifestyle changes",
    description: "Occurs when blood flow to the heart muscle is blocked, causing heart tissue damage.",
  ...
  },
  {
    ...
    precautions: "Nitroglycerin, avoid physical exertion triggers, treat underlying coronary disease",
    description: "Chest pain or pressure caused by reduced blood flow to the heart muscle.",
    medicines: "Nitroglycerin, Aspirin, Beta-blockers (Atenolol), Isosorbide mononitrate"
  },
  {
    id: "d30",
    name: "Heart Failure",
    ...
    precautions: "Medication adherence, daily weight monitoring, fluid restriction, cardiac rehab",
  ...
  },
  {
    ...
    precautions: "Rate/rhythm control medications, anticoagulants, cardioversion if needed",
    description: "An irregular and often rapid heart rate that can increase risk of strokes and heart failure.",
  ...
  },
  {
    ...
    precautions: "Immediate medical care (FAST), blood thinners, physical therapy, control risk factors",
    description: "Occurs when blood supply to part of the brain is cut off, causing brain cell death.",
  ...
  },
  {
    ...
    description: "Most common type of anemia where blood lacks adequate healthy red blood cells due to iron deficiency.",
    medicines: "Ferrous sulfate, Ferric carboxymaltose (IV), Folic acid, Vitamin C"
  },
  {
    id: "d34",
    name: "Leukemia",
    ...
    precautions: "Chemotherapy, radiation, stem cell transplant, infection prevention",
    description: "Cancer of the blood-forming tissues including bone marrow and the lymphatic system.",
  ...
  },
  {
    ...
    medicines: "Rituximab, CHOP regimen (Cyclophosphamide, Doxorubicin, Vincristine, Prednisone)"
  },
  {
    id: "d36",
    ...
    precautions: "Insulin therapy, blood sugar monitoring, foot care, regular eye exams",
    description: "An autoimmune disease where the pancreas produces little or no insulin.",
    medicines: "Insulin (Glargine, Lispro), Metformin (adjunct), Glucagon (emergency)"
  },
  {
    id: "d37",
    ...
    precautions: "Blood sugar monitoring, oral medications or insulin, lifestyle changes, regular checkups",
    description: "A chronic condition affecting how the body metabolizes sugar, with insulin resistance.",
  ...
  },
  {
    ...
    description: "Underactive thyroid not producing enough hormones to meet the body needs.",
  ...
  },
  {
    ...
    precautions: "Antithyroid medications, radioactive iodine therapy, beta-blockers, thyroid surgery",
    description: "Overactive thyroid producing too much thyroxine hormone.",
    medicines: "Carbimazole, Propylthiouracil, Propranolol, Radioactive iodine (I-131)"
  },
  {
    id: "d40",
    name: "PCOS",
    ...
    precautions: "Weight management, hormonal therapy, regular gynecological checkups",
    description: "Polycystic ovary syndrome - hormonal disorder causing enlarged ovaries with small cysts.",
    medicines: "Metformin, Clomiphene, Combined oral contraceptives, Spironolactone"
  },
  {
    id: "d41",
    name: "Migraine",
    ...
    precautions: "Identify and avoid triggers, prophylactic medications, pain relief, rest in dark room",
    description: "A neurological condition causing severe recurring headaches often with nausea and light sensitivity.",
    medicines: "Sumatriptan, Ibuprofen, Topiramate (prevention), Propranolol (prevention)"
  },
  {
    id: "d42",
    name: "Epilepsy",
    ...
    precautions: "Antiepileptic medications, avoid triggers, safety measures, regular neurology followup",
    description: "A neurological disorder characterized by unprovoked, recurrent seizures.",
  ...
  },
  {
    ...
    precautions: "Levodopa medications, physical therapy, fall prevention, deep brain stimulation",
    description: "A progressive nervous system disorder affecting movement with tremors and stiffness.",
  ...
  },
  {
    ...
    precautions: "Cognitive stimulation, medications, caregiver support, safe environment",
    description: "A progressive neurological disorder causing brain cells to waste away and die.",
  ...
  },
  {
    ...
    precautions: "Disease-modifying therapies, physical therapy, symptom management",
    description: "A disease in which the immune system eats away at the protective covering of nerves.",
    medicines: "Interferon beta, Glatiramer acetate, Natalizumab, Dimethyl fumarate"
  },
  {
    id: "d46",
    ...
    precautions: "DMARDs, NSAIDs, physical therapy, joint protection techniques",
    description: "An autoimmune disease causing painful inflammation and can eventually cause joint deformity.",
  ...
  },
  {
    ...
    precautions: "Weight-bearing exercise, bisphosphonates, fall prevention, bone density monitoring",
    description: "A bone disease where increased bone weakness increases the risk of a broken bone.",
  ...
  },
  {
    ...
    precautions: "Uric acid lowering medications, avoid purine-rich foods, joint rest during attack",
    description: "A form of inflammatory arthritis characterized by sudden severe attacks of pain in joints.",
  ...
  },
  {
    ...
    precautions: "Sun protection, immunosuppressants, monitor organ function, avoid triggers",
  ...
  },
  {
    ...
    precautions: "Topical treatments, phototherapy, biologics, moisturize regularly",
    description: "A skin disease causing red, itchy scaly patches most commonly on knees, elbows, and trunk.",
    medicines: "Topical corticosteroids, Methotrexate, Adalimumab (biologic), Calcipotriol cream"
  },
  {
    id: "d51",
    name: "Eczema",
    ...
    precautions: "Moisturize frequently, avoid triggers, topical corticosteroids, gentle skincare",
    description: "A condition that makes skin red and itchy, often appearing in childhood.",
    medicines: "Hydrocortisone cream, Cetirizine, Tacrolimus ointment, Emollient creams"
  },
  {
    id: "d52",
    ...
    precautions: "Antihistamines, nasal corticosteroids, allergen avoidance, immunotherapy",
    description: "Inflammation of the inside of the nose caused by an allergen such as pollen or dust.",
  ...
  },
  {
    ...
    precautions: "Varicella vaccine, avoid scratching, calamine lotion, isolate from vulnerable people",
    description: "A highly contagious disease caused by varicella-zoster virus causing itchy blisters.",
    medicines: "Calamine lotion, Paracetamol, Acyclovir (for severe cases), Cetirizine"
  },
  {
    id: "d54",
    name: "Measles",
    ...
    description: "A highly contagious viral infection causing fever, rash, and potential serious complications.",
  ...
  },
  {
    ...
    description: "A viral infection primarily affecting the salivary glands causing swollen cheeks.",
  ...
  },
  {
    ...
    precautions: "Meningococcal vaccine, immediate hospitalization, antibiotics for bacterial type",
  ...
  },
  {
    ...
    precautions: "Hospitalization, antiviral or anti-inflammatory treatment, supportive care",
    description: "Inflammation of the brain usually caused by a viral infection.",
  ...
  },
  {
    ...
    precautions: "Cognitive behavioral therapy, anxiolytics, mindfulness, regular exercise",
    description: "A mental health disorder characterized by persistent and excessive worry about various things.",
  ...
  },
  {
    ...
    precautions: "Trauma-focused therapy, EMDR, medications, strong support network",
    description: "Post-traumatic stress disorder - a mental health condition triggered by experiencing or witnessing a traumatic event.",
  ...
  },
  {
    ...
    precautions: "Antipsychotic medications, psychiatric care, community support, family education",
  ...
  },
  {
    ...
    precautions: "Mood stabilizers, antipsychotics, psychotherapy, regular monitoring",
    description: "A mental health condition causing extreme mood swings including emotional highs and lows.",
  ...
  },
  {
    ...
    precautions: "Inpatient/outpatient eating disorder program, therapy, medical monitoring",
    description: "An eating disorder characterized by an abnormally low body weight, fear of gaining weight.",
    medicines: "Olanzapine, Multivitamins, SSRIs (for co-occurring depression), Nutritional supplements"
  },
  {
    id: "d64",
    name: "Obesity",
    ...
    precautions: "Lifestyle modification, behavioral therapy, medications, bariatric surgery if indicated",
    description: "Excessive body fat accumulation that presents a risk to health.",
    medicines: "Orlistat, Phentermine-topiramate, Semaglutide (Ozempic), Metformin"
  },
  {
    id: "d65",
    ...
    description: "Insufficient vitamin D in the body leading to bone weakness and other health issues.",
    medicines: "Vitamin D3 (Cholecalciferol), Calcium carbonate, Calcitriol (severe deficiency)"
  },
  {
    id: "d66",
    name: "Celiac Disease",
    ...
    precautions: "Lifelong gluten avoidance, read food labels, avoid cross-contamination",
    description: "An immune reaction to eating gluten causing damage to the small intestine.",
    medicines: "Iron supplements, Folic acid, Vitamin B12, Calcium + Vitamin D (deficiency correction)"
  },
  {
    id: "d67",
    name: "Hypoglycemia",
    ...
    precautions: "Regular glucose monitoring, fast-acting sugar for emergencies, adjust diabetes medications",
    description: "Abnormally low blood sugar levels causing neurological and autonomic symptoms.",
    medicines: "Glucose tablets, Glucagon injection (emergency), Dextrose IV (hospital), Diazoxide"
  },
  {
    id: "d68",
    ...
    precautions: "Anticoagulants, compression stockings, regular movement, avoid prolonged immobility",
    description: "A blood clot that forms in a vein deep inside the body, usually in the legs.",
  ...
  },
  {
    ...
    precautions: "Immediate hospitalization, anticoagulants, thrombolytics in severe cases",
  ...
  },
  {
    ...
    precautions: "Immediate hospitalization, IV antibiotics, fluid resuscitation, organ support",
    description: "A life-threatening medical emergency triggered by the body response to an infection.",
    medicines: "IV Broad-spectrum antibiotics (Piperacillin-Tazobactam), Norepinephrine, IV fluids, Hydrocortisone"
  },
  {
    id: "d71",
    name: "Hyponatremia",
    ...
    precautions: "IV sodium correction, treat underlying cause, fluid restriction in chronic cases",
    description: "Abnormally low sodium levels in blood, disrupting water balance in cells.",
    medicines: "IV Normal saline (3% NaCl), Tolvaptan, Demeclocycline, Fluid restriction"
  },
  {
    id: "d72",
    name: "Sleep Apnea",
    ...
    precautions: "CPAP therapy, weight loss, sleep positioning, avoid sedatives",
    description: "A potentially serious sleep disorder where breathing repeatedly stops and starts during sleep.",
    medicines: "CPAP device, Modafinil (daytime sleepiness), Acetazolamide, Uvulopalatopharyngoplasty (surgical)"
  },
  {
    id: "d73",
    ...
    precautions: "Regular thyroid ultrasound, fine needle aspiration if indicated, medication or surgery",
    description: "Unusual growths or lumps in the thyroid gland that may or may not produce hormones.",
    medicines: "Levothyroxine (suppression therapy), Radioactive iodine (if toxic), Ethanol ablation"
  },
  {
    id: "d74",
    ...
    precautions: "Reduce corticosteroids if medication-induced, surgery for tumors, monitoring",
    description: "Occurs when the body is exposed to high levels of cortisol for too long.",
  ...
  },
  {
    ...
    precautions: "Immunosuppressants, physical therapy, monitor lung and heart function",
    description: "A group of rare diseases that involve hardening and tightening of the skin and connective tissues.",
    medicines: "Methotrexate, Mycophenolate mofetil, Nifedipine (Raynaud's), Sildenafil (pulmonary hypertension)"
  },
  // ===== STOMACH DISEASES (d76-d80) =====
  {
    ...
    precautions: "Avoid smoking and alcohol, treat H. pylori infection, regular endoscopy if high risk, avoid NSAIDs",
    description: "A malignant tumor of the stomach lining, often diagnosed late due to vague early symptoms.",
    medicines: "Fluorouracil (5-FU), Cisplatin, Trastuzumab (HER2+), Ramucirumab, Oxaliplatin"
  },
  {
    id: "d77",
    name: "Gastroparesis",
    ...
    precautions: "Avoid high-fat and high-fiber foods, stay upright after eating, manage blood sugar in diabetics",
    description: "A condition where the stomach cannot empty itself of food normally, causing delayed gastric emptying.",
    medicines: "Metoclopramide, Domperidone, Erythromycin, Ondansetron, Pantoprazole"
  },
  {
    id: "d78",
    ...
    precautions: "Take medications as prescribed, avoid NSAIDs, regular colonoscopy, manage stress",
    description: "A chronic inflammatory bowel disease causing long-lasting inflammation and ulcers in the digestive tract, primarily the colon.",
  ...
  },
  {
    ...
    precautions: "Complete full antibiotic course, avoid NSAIDs, wash hands frequently, avoid contaminated food/water",
    description: "A bacterial infection of the stomach lining that can cause gastritis, peptic ulcers, and increase risk of stomach cancer.",
    medicines: "Amoxicillin, Clarithromycin, Metronidazole, Omeprazole, Bismuth subsalicylate"
  },
  {
    id: "d80",
    name: "Stomach Polyps",
    ...
    precautions: "Regular endoscopic surveillance, H. pylori treatment if present, avoid PPIs long-term",
    description: "Abnormal tissue growths that form on the lining of the stomach; most are benign but some types may develop into cancer.",
    medicines: "Omeprazole (reduce fundic polyps), H. pylori eradication therapy, aspirin (investigational)"
  },
  // ===== CANCER TYPES (d81-d91) =====
  {
    ...
    precautions: "Regular mammograms, breast self-exams, maintain healthy weight, limit alcohol, avoid hormone therapy if possible",
    description: "A cancer that forms in the cells of the breasts, the most common cancer in women worldwide.",
    medicines: "Tamoxifen, Letrozole, Trastuzumab (Herceptin), Paclitaxel, Doxorubicin"
  },
  {
    id: "d82",
    name: "Lung Cancer",
    ...
    precautions: "Stop smoking immediately, avoid secondhand smoke and radon, lung cancer screening if high risk",
    description: "A cancer that begins in the lungs, the leading cause of cancer death worldwide, strongly associated with smoking.",
  ...
  },
  {
    ...
    precautions: "Regular colonoscopy after age 45, avoid processed meats, maintain healthy weight, regular exercise",
    description: "Cancer of the colon or rectum, the third most common cancer globally, often developing from polyps.",
    medicines: "Fluorouracil (5-FU), Oxaliplatin, Bevacizumab, Cetuximab, Irinotecan"
  },
  {
    id: "d84",
    ...
    precautions: "Regular PSA screening after age 50, avoid high-fat diet, maintain healthy weight",
    description: "A cancer occurring in the prostate gland, one of the most common cancers in men, often slow-growing.",
  ...
  },
  {
    ...
    precautions: "Use SPF 30+ sunscreen daily, avoid tanning beds, regular skin checks, protective clothing",
  ...
  },
  {
    ...
    precautions: "Avoid smoking, limit alcohol, manage diabetes, regular monitoring if family history exists",
    description: "A highly aggressive cancer of the pancreas that is difficult to detect early and has a poor prognosis.",
    medicines: "Gemcitabine, Nab-paclitaxel, Erlotinib, FOLFIRINOX regimen, Pancreatic enzyme replacement"
  },
  {
    id: "d87",
    ...
    precautions: "HPV vaccination, regular Pap smears, avoid smoking, practice safe sex",
    description: "A cancer of the cervix caused primarily by persistent infection with high-risk strains of HPV.",
    medicines: "Cisplatin, Paclitaxel, Bevacizumab, Fluorouracil, Pembrolizumab"
  },
  {
    id: "d88",
    name: "Ovarian Cancer",
    ...
    precautions: "Know family history, genetic testing for BRCA mutations, report persistent abdominal symptoms",
    description: "Cancer arising from ovarian cells, often called the silent killer due to vague early symptoms and late diagnosis.",
  ...
  },
  {
    ...
    precautions: "Stop smoking, avoid workplace chemical exposure, stay well hydrated, report blood in urine immediately",
    description: "Cancer that begins in the cells lining the bladder, strongly linked to smoking and chemical exposures.",
    medicines: "BCG therapy, Mitomycin C, Cisplatin, Gemcitabine, Pembrolizumab"
  },
  {
    id: "d90",
    ...
    precautions: "Treat hepatitis B/C, avoid alcohol, maintain healthy weight, regular liver imaging if cirrhosis present",
    description: "The most common type of primary liver cancer, often developing in people with chronic liver disease or cirrhosis.",
    medicines: "Sorafenib, Lenvatinib, Atezolizumab, Bevacizumab, Transarterial chemoembolization"
  },
  {
    id: "d91",
    name: "Oral Cancer",
    ...
    precautions: "Avoid tobacco and alcohol, HPV vaccination, regular dental exams, oral self-examination monthly",
    description: "Cancer affecting the lips, tongue, cheeks, floor of the mouth, hard palate, and throat.",
  ...
  // ===== BRAIN TUMORS (d92-d96) =====
  {
    ...
    precautions: "Avoid radiation exposure to head, regular MRI monitoring, seizure precautions, mental health support",
    description: "The most aggressive type of primary brain cancer with a median survival of 14-16 months despite treatment.",
    medicines: "Temozolomide, Bevacizumab, Carmustine (BCNU), Dexamethasone, Levetiracetam"
  },
  {
    id: "d93",
    name: "Meningioma",
    ...
    precautions: "Avoid head radiation, regular MRI monitoring, note any neurological changes promptly",
    description: "A usually benign tumor that arises from the meninges, the membranes surrounding the brain and spinal cord.",
    medicines: "Hydroxyurea, Octreotide, Bevacizumab, Dexamethasone, Mifepristone"
  },
  {
    id: "d94",
    name: "Astrocytoma",
    ...
    precautions: "Regular neurological evaluations, seizure management, avoid excessive radiation exposure",
    description: "A type of brain tumor that originates from star-shaped brain cells called astrocytes; ranges from low to high grade.",
    medicines: "Temozolomide, Carmustine (BCNU), Vincristine, Carboplatin, Dexamethasone"
  },
  {
    id: "d95",
    ...
    precautions: "Regular hormonal blood tests, vision monitoring, medication compliance, avoid stress",
    description: "A benign tumor of the pituitary gland that may cause hormonal imbalances or pressure-related symptoms.",
    medicines: "Bromocriptine, Cabergoline, Octreotide, Lanreotide, Pegvisomant"
  },
  {
    id: "d96",
    ...
    precautions: "Regular brain imaging, seizure prophylaxis, coordinate care with oncology team, supportive care",
    description: "Cancerous tumors in the brain that have spread from cancer in another part of the body.",
    medicines: "Dexamethasone, Levetiracetam, Temozolomide, Whole-brain radiation therapy, Stereotactic radiosurgery"
  },
  // ===== KIDNEY DISEASES (d97-d99) =====
  {
    ...
    precautions: "Complete antibiotic course, stay well hydrated, avoid delaying urination, wipe front to back",
    description: "A bacterial kidney infection that can cause serious health problems if not treated promptly.",
    medicines: "Ciprofloxacin, Trimethoprim-sulfamethoxazole, Ceftriaxone, Amoxicillin-clavulanate, Gentamicin"
  },
  {
    id: "d98",
    ...
    precautions: "Blood pressure management, regular kidney function tests, avoid contact sports, genetic counseling",
    description: "A genetic disorder causing clusters of cysts to develop in the kidneys, potentially leading to kidney failure.",
    medicines: "Tolvaptan, Lisinopril, Amlodipine, Furosemide, Pain management medications"
  },
  {
    id: "d99",
    ...
    precautions: "Blood pressure monitoring, weight monitoring, prevent infections, anticoagulation if indicated",
    description: "A kidney disorder causing the kidneys to excrete too much protein in urine, leading to edema and low blood protein.",
  ...
  // ===== LIVER & GALLBLADDER (d100-d102) =====
  {
    ...
    precautions: "Weight management, avoid alcohol, control diabetes and cholesterol, regular liver monitoring",
    description: "Accumulation of excess fat in the liver not caused by alcohol, affecting 25% of the global population.",
    medicines: "Vitamin E, Pioglitazone, Metformin, Obeticholic acid, Liraglutide"
  },
  {
    id: "d101",
    ...
    precautions: "Maintain healthy weight through gradual weight loss, avoid high-fat meals, regular exercise",
    description: "Hardened deposits of digestive fluid that can form in the gallbladder, often causing episodic right-sided abdominal pain.",
    medicines: "Ursodeoxycholic acid, NSAIDs for pain, Ketorolac, Hyoscine butylbromide"
  },
  {
    id: "d102",
    ...
    precautions: "Seek immediate medical care, avoid all fatty foods, nil by mouth if surgery planned",
    description: "Inflammation of the gallbladder, usually caused by gallstones blocking the bile duct.",
    medicines: "Cefazolin, Metronidazole, Morphine, Ketorolac, Ursodeoxycholic acid"
  },
  // ===== EYE DISEASES (d103-d106) =====
  {
    ...
    precautions: "Regular eye pressure checks, use prescribed eye drops consistently, avoid head-down positions",
    description: "A group of eye conditions damaging the optic nerve due to increased intraocular pressure, potentially causing blindness.",
  ...
  },
  {
    ...
    precautions: "Wear UV-protective sunglasses, control diabetes, avoid smoking, regular eye exams",
    description: "Clouding of the normally clear lens of the eye, causing blurry vision and glare sensitivity.",
    medicines: "N-acetylcarnosine eye drops, Antioxidant supplements (preventive), Surgical lens replacement (definitive)"
  },
  {
    id: "d105",
    ...
    precautions: "Strict blood sugar and blood pressure control, regular dilated eye exams, avoid smoking",
    description: "A diabetes complication affecting the eyes, caused by damage to the blood vessels of the light-sensitive tissue in the retina.",
    medicines: "Anti-VEGF injections (Ranibizumab, Bevacizumab), Corticosteroid implants, Laser photocoagulation"
  },
  {
    id: "d106",
    name: "Conjunctivitis",
    ...
    precautions: "Avoid touching eyes, wash hands frequently, avoid sharing towels/eye makeup, avoid contact lenses during infection",
    description: "Inflammation or infection of the conjunctiva, the transparent membrane lining the eyelid and eyeball.",
    medicines: "Erythromycin eye ointment, Ciprofloxacin eye drops, Olopatadine (allergic), Artificial tears"
  },
  // ===== NOSE & SINUS (d107-d108) =====
  {
    ...
    precautions: "Use saline nasal irrigation, avoid allergens, use air humidifier, treat allergies promptly",
    description: "Long-lasting inflammation of the sinuses, the hollow air spaces within the bones surrounding the nose.",
    medicines: "Mometasone nasal spray, Budesonide, Amoxicillin-clavulanate, Pseudoephedrine, Guaifenesin"
  },
  {
    id: "d108",
    name: "Nasal Polyps",
    ...
    precautions: "Use nasal steroid sprays, identify and avoid triggers, treat allergies, consider surgery if refractory",
    description: "Soft, noncancerous growths on the lining of the nasal passages or sinuses, often causing blockage.",
    medicines: "Fluticasone nasal spray, Oral prednisone, Dupilumab, Mepolizumab, Omalizumab"
  },
  // ===== EAR DISEASES (d109-d110) =====
  {
    ...
    precautions: "Breastfeed infants, avoid secondhand smoke, vaccination with pneumococcal and Hib vaccines",
    description: "Infection or inflammation in the middle ear space behind the eardrum, common in children.",
    medicines: "Amoxicillin, Amoxicillin-clavulanate, Ibuprofen, Acetaminophen, Ciprofloxacin ear drops"
  },
  {
    id: "d110",
    ...
    precautions: "Low-salt diet strictly, avoid alcohol and caffeine, manage stress, sleep on elevated pillow",
    description: "A disorder of the inner ear causing episodes of vertigo, tinnitus, hearing loss, and ear pressure.",
    medicines: "Meclizine, Diuretics (hydrochlorothiazide), Betahistine, Diazepam, Prednisone"
  },
  // ===== MOUTH DISEASES (d111-d112) =====
  {
    ...
    precautions: "Brush and floss twice daily, regular dental cleanings, quit smoking, control diabetes",
    description: "A serious gum infection that damages the soft tissue and bone supporting the teeth, potentially causing tooth loss.",
    medicines: "Doxycycline, Metronidazole, Chlorhexidine mouthwash, Arestin (minocycline), Scaling and root planing"
  },
  {
    id: "d112",
    ...
    precautions: "Stay hydrated, use fluoride toothpaste, avoid mouthwashes with alcohol, review medications",
    description: "A condition where the salivary glands don't produce enough saliva to keep the mouth moist.",
    medicines: "Pilocarpine, Cevimeline, Artificial saliva sprays, Biotene products, Fluoride treatments"
  },
  // ===== LUNG DISEASES (d113-d114) =====
  {
    ...
    precautions: "Stop smoking immediately, avoid lung irritants, supplemental oxygen, pulmonary rehabilitation, flu and pneumonia vaccination",
    description: "Scarring and thickening of lung tissue that worsens over time, making it progressively harder to breathe.",
    medicines: "Pirfenidone, Nintedanib, N-acetylcysteine, Prednisone, Sildenafil (pulmonary hypertension)"
  },
  {
    id: "d114",
    name: "Pleurisy",
    ...
    precautions: "Treat underlying cause, adequate rest, avoid strenuous activity, use of pillows to support breathing",
    description: "Inflammation of the pleura, the tissue lining the lungs and chest cavity, causing sharp chest pain with breathing.",
    medicines: "Ibuprofen, Naproxen, Colchicine, Prednisone, Codeine (cough suppression)"
  },
  // ===== EXCRETORY SYSTEM (d115-d116) =====
  {
    ...
    precautions: "Avoid straining, increase fiber intake gradually, sitz baths, avoid prolonged sitting on toilet",
    description: "Swollen and inflamed veins in the rectum and anus that cause discomfort and bleeding.",
    medicines: "Hydrocortisone cream, Witch hazel, Docusate sodium (stool softener), Fiber supplements, Phenylephrine suppositories"
  },
  {
    id: "d116",
    name: "Diverticulitis",
    ...
    precautions: "High fiber diet when not flaring, stay hydrated, regular exercise, maintain healthy weight",
    description: "Inflammation or infection of small pouches that develop in the digestive tract, usually in the colon.",
    medicines: "Ciprofloxacin, Metronidazole, Amoxicillin-clavulanate, Mesalamine, Fiber supplements"
  },
  // ===== PARALYSIS CONDITIONS (d117-d119) =====
  {
    ...
    precautions: "Eye protection (artificial tears, patching at night), physical therapy, early corticosteroid treatment",
    description: "Sudden, temporary weakness or paralysis of facial muscles on one side of the face due to facial nerve inflammation.",
    medicines: "Prednisone, Acyclovir or Valacyclovir, Artificial tears, Lubricant eye ointment, Vitamin B12"
  },
  {
    id: "d118",
    name: "Cerebral Palsy",
    ...
    precautions: "Physical and occupational therapy, assistive devices, seizure management, regular dental care",
    description: "A group of movement disorders caused by brain damage during fetal development or shortly after birth.",
    medicines: "Baclofen, Botulinum toxin, Diazepam, Tizanidine, Levetiracetam (seizures)"
  },
  {
    id: "d119",
    ...
    precautions: "Pressure sore prevention, bowel and bladder management program, physical rehabilitation, prevent infections",
    description: "Damage to the spinal cord resulting in loss of movement, sensation, and autonomic function below the injury level.",
    medicines: "Methylprednisolone (acute), Baclofen, Oxybutynin, Gabapentin, Sildenafil"
  },
  // ===== HAIR FALL CONDITIONS (d120-d122) =====
  {
    ...
    precautions: "Avoid tight hairstyles, minimize heat styling, manage stress, avoid harsh chemical treatments",
    description: "The most common type of hair loss caused by a combination of genetic predisposition and androgen hormones.",
    medicines: "Minoxidil (topical), Finasteride (oral for men), Dutasteride, Spironolactone (women), Platelet-rich plasma therapy"
  },
  {
    id: "d121",
    ...
    precautions: "Manage stress, protect scalp from sun exposure, support groups, avoid scalp trauma",
    description: "An autoimmune condition causing patchy hair loss on the scalp and other parts of the body.",
    medicines: "Corticosteroid injections, Minoxidil, Anthralin, Diphencyprone (DPCP), Baricitinib"
  },
  {
    id: "d122",
    ...
    precautions: "Identify and treat underlying cause, manage stress, avoid crash diets, review medications",
    description: "Diffuse hair shedding triggered by physical or emotional stress, nutritional deficiencies, or hormonal changes.",
    medicines: "Iron supplements (if deficient), Biotin, Zinc supplements, Minoxidil, Vitamin D supplementation"
  }
];
const symptoms = [
  // GENERAL
...
async function analyzeWithAI(symptoms2, apiKey) {
  var _a2, _b2, _c2;
  try {
    const response = await fetch("https://api.openai.com/v1/chat/completions", {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: "system",
            content: "You are a medical AI assistant. Given a list of symptoms, provide a brief diagnostic analysis mentioning possible conditions. Always remind the user to consult a real doctor. Keep response under 200 words."
          },
          {
            role: "user",
            content: `The patient reports the following symptoms: ${symptoms2.join(", ")}. What conditions should be considered?`
          }
        ],
        max_tokens: 250
      })
    ...
    return ((_c2 = (_b2 = (_a2 = data.choices) == null ? void 0 : _a2[0]) == null ? void 0 : _b2.message) == null ? void 0 : _c2.content) ?? null;
  } catch {
    return null;
  }
}
function matchDiseases(selectedSymptoms, diseases2) {
  if (selectedSymptoms.length === 0) return [];
  const results = diseases2.map((disease) => {
    const matchedSymptoms = disease.symptoms.filter(
      (s) => selectedSymptoms.includes(s)
    );
    const matchCount = matchedSymptoms.length;
    if (matchCount === 0) return null;
    const score = 0.7 * (matchCount / disease.symptoms.length) + 0.3 * (matchCount / selectedSymptoms.length);
    const confidence = Math.min(Math.round(score * 100), 99);
    return { disease, confidence, matchCount, matchedSymptoms };
  }).filter((r) => r !== null).sort((a, b) => b.confidence - a.confidence).slice(0, 5);
  return results;
}
function App() {
  const [activated, setActivated] = reactExports.useState(false);
  const [apiKey, setApiKey] = reactExports.useState("");
  const [apiKeyActive, setApiKeyActive] = reactExports.useState(false);
  ...
  const [showActivation, setShowActivation] = reactExports.useState(false);
  ...
  const handleAnalyze = async () => {
    ...
    setTimeout(() => {
      var _a2;
      (_a2 = document.getElementById("results")) == null ? void 0 : _a2.scrollIntoView({ behavior: "smooth" });
    }, 100);
  };
  if (!activated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(ActivationScreen, { onActivate: handleActivate });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `app-root${theme === "light" ? " theme-light" : ""}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleCanvas, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(HUDOverlay, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Navbar,
      {
        theme,
    ...
    showActivation && /* @__PURE__ */ jsxRuntimeExports.jsx(ActivationScreen, { onActivate: handleActivate })
  ] });
}
