...
function ActivationScreen({ onActivate }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "activation-overlay", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "activation-card", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "activation-logo", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "svg",
      {
        width: "48",
        height: "48",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "24", cy: "24", r: "4", fill: "#19D7FF" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "line",
            {
              x1: "24",
...
const severityColors$1 = {
  low: "#28E3A3",
  medium: "#facc15",
  high: "#f97316",
  critical: "#ef4444"
};
function DiseaseDatabase({ diseases: diseases2 }) {
  const [search, setSearch] = reactExports.useState("");
  const [severityFilter, setSeverityFilter] = reactExports.useState("all");
  const filtered = reactExports.useMemo(() => {
    return diseases2.filter((d) => {
      const matchSearch = d.name.toLowerCase().includes(search.toLowerCase());
      const matchSev = severityFilter === "all" || d.severity === severityFilter;
      return matchSearch && matchSev;
    });
  }, [diseases2, search, severityFilter]);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "database-section", id: "database", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-header", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-title", children: "DISEASE DATABASE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-line" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "database-controls", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "severity-filters", children: ["all", "low", "medium", "high", "critical"].map((sev) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
          className: `sev-filter${severityFilter === sev ? " active" : ""}`,
          style: severityFilter === sev && sev !== "all" ? {
            background: `${severityColors$1[sev]}22`,
            borderColor: severityColors$1[sev],
            color: severityColors$1[sev]
          } : {},
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "disease-grid", children: filtered.map((d) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disease-card glass-card", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disease-card-header", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "disease-name", children: d.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            className: "severity-badge",
            style: {
              color: severityColors$1[d.severity],
              borderColor: severityColors$1[d.severity],
              background: `${severityColors$1[d.severity]}22`
            },
            children: d.severity.toUpperCase()
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "disease-desc", children: d.description }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disease-symptoms", children: [
        d.symptoms.slice(0, 4).map((s) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "disease-sym-tag", children: s }, s)),
        d.symptoms.length > 4 && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "disease-sym-more", children: `+${d.symptoms.length - 4}` })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disease-info", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disease-info-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "info-label", children: "🥗 DIET" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "info-text", children: d.diet })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "disease-info-row", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "info-label", children: "🛡 PRECAUTIONS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "info-text", children: d.precautions })
        ] })
      ] })
    ] }, d.id)) })
  ] });
...
function Hero() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-visual", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "holo-ring ring-outer" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "holo-ring ring-mid" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "holo-ring ring-inner" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "holo-core", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "30", cy: "30", r: "5", fill: "#19D7FF" }),
            ringAngles.map((deg) => {
...
function Navbar({ theme, onToggleTheme, isActivated }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "navbar", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "svg",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "14", cy: "14", r: "5", fill: "#19D7FF", opacity: "0.8" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "line",
              {
                x1: "14",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "navbar-links", children: ["scan", "results", "database"].map((id) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "button",
      {
        type: "button",
        className: "nav-link",
    ...
    isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loading-panel", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "glass-card card-cyan result-top", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "result-confidence-big", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { style: { color: "#19D7FF" }, children: [
...
function App() {
  ...
  if (!isActivated) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `app-root theme-${theme}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleCanvas, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(ActivationScreen, { onActivate: handleActivate })
    ] });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `app-root theme-${theme}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(ParticleCanvas, {}),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "main-content", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(DiseaseDatabase, { diseases })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "app-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "footer-brand", children: "MEDAI NEXUS © 2026" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "footer-status", children: "● SYSTEM ONLINE" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "footer-disclaimer", children: "For informational purposes only. Consult a medical professional." })
    ] })
  ] });
}
