                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        background: isActive
                          ? "linear-gradient(135deg, rgba(131,135,195,0.18), rgba(149,187,181,0.12))"
                          : "transparent",
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    background: isActive
                      ? "linear-gradient(135deg, rgba(131,135,195,0.12), rgba(149,187,181,0.08))"
                      : "transparent",
                ...
                <button
                  ...
                  style={{
                    ...
                    background: isSelected
                      ? "linear-gradient(135deg, rgba(131,135,195,0.15), rgba(149,187,181,0.1))"
                      : "var(--accent-dim)",
          ...
          >
            ...
            >
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.background = "rgba(131,135,195,0.15)";
                  e.currentTarget.style.boxShadow = "var(--glow-soft)";
                }}
                onMouseLeave={(e) => {
                  e.currentTarget.style.background = "var(--accent-dim)";
      ...
      {selected.length > 0 && (
        <button
          ...
          style={{
            ...
            zIndex: 100,
            background: canSubmit ? undefined : "rgba(131,135,195,0.2)",
